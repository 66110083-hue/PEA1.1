...
const selectedTransformer =
  ref<typeof transformers.value[0] | null>(null)
        ...
        <template #actions>
          ...
          >
            ...
            <div style="position:relative">
              ...
              <input
                v-model="searchQuery"
                placeholder="Search by PEA No. / Device ID"
                style="

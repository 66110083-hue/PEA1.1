...
import TransformerDetail    from '~/components/PageTransformer/TransformerDetail.vue'  // ← เพิ่ม
...
<template>
  <div style="display:flex;flex-direction:column;gap:16px">
    ...
    <template v-if="showDetail && selectedTransformer">
      ...
      <!-- Detail component -->
      <TransformerDetail :transformer="selectedTransformer" />
              ...
              <tr v-for="row in filteredData" :key="row.id">
                ...
                <td>
                  <div style="display:flex;gap:6px">
                    <!-- ปุ่ม View → เปิด Detail แทน Modal -->
    ...
    <!-- Modal (Edit / Delete) — ยังคงใช้งานได้ปกติ -->

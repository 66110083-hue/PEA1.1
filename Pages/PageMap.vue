...
import LocationFilter from './sub-components/LocationFilter.vue'
import SiteMap        from './sub-components/SiteMap.vue'
import SiteDetail     from './sub-components/SiteDetail.vue'
